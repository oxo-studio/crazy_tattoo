        ...
        <div className="w-full -mt-24 mb-20">
            <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-3 md:gap-6 relative items-start">
                ...
                <div className="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 mb-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                    </svg>
                    <h2 className="text-3xl lg:text-4xl md:text-3xl sm:text-2xl climate-crisis mb-4">{t("contattaci")}</h2>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h2 className="text-3xl lg:text-4xl md:text-3xl sm:text-2xl climate-crisis mb-4">{t("orari")}</h2>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h2 className="text-3xl lg:text-4xl md:text-3xl sm:text-2xl climate-crisis mb-4">{t("dove")}</h2>
