...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <h1 className="ombre text-4xl  sm:text-6xl md:text-7xl md:ml-[40px] lg:text-8xl font-bold tracking-tight climate-crisis">
  {splitText('CRAZY N TINA TATTOO', titleRef)}
</h1>

        <p className="mt-8 ombre text-2xl ml-[-3px] md:ml-hidden sm:text-base md:text-4xl lg:text-5xl courgette-regular">
        ...
        <div className="mt-8 animate-bounce">
          <Link
            to="/contatti"
            className="text-2xl ombre sm:text-base md:text-4xl lg:text-4xl font-semibold text-white courgette-regular animate-bounce link chisiamo"
          >
