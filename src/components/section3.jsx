            ...
            <div className="section2-content max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-24">
                ...
                <div className="image2-container relative flex justify-center items-center gap-6 flex-wrap pb-8">
                    ...
                    <img 
                        ...
                        className="paralax-image2 background-image3 shadow-lg w-96 sm:w-1/2 md:w-1/3 lg:w-2/2 hidden  lg:block md:block"
                    />
                </div>

                {/* Testo sovrapposto */}
                <div className="paralax-test2 mt-[500px] sm:mt-[400px] lg:mt-[400px] text-center">
